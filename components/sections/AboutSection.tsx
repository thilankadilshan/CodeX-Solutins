'use client'
// components/sections/AboutSection.tsx â€” Professional, sharp, data-driven
            ...
            <div className="grid sm:grid-cols-2 gap-x-8 gap-y-4 mb-12">
              {VALUES.map((v) => (
                <div key={v} className="flex items-start gap-3">
                  <Check size={18} className="text-teal-500 mt-1 flex-shrink-0" strokeWidth={3} />
            ...
            <div className="grid grid-cols-2 gap-4">
              {STATS.map((stat, i) => (
                <motion.div
                  ...
                  className="p-8 bg-[#0C1627] border border-white/10"
                >
